...
donnons un test exact, conditionnel au fil, qui décide si un journal de recommandation
permet seulement une correction d'exposition, et un estimateur de la sévérité du biais de
position. Appliqués à trois journaux publics, ils établissent que MIND ne conserve pas
l'ordre servi --- l'estimateur y produit cinq sévérités incompatibles --- tandis que
Baidu-ULTR le conserve ($\hat\eta = 1{,}10 \pm 0{,}09$) et que l'Open Bandit Dataset permet
la seule confrontation de ce travail à une vérité terrain : la valeur d'une politique jamais
déployée y est retrouvée à $2{,}5\,\%$, contre $31{,}6\,\%$ d'erreur pour l'estimation naïve.
...
Act}, quatre tableaux agrégés sans donnée personnelle, dont il est vérifié qu'ils
recalculent les mesures à l'identique pour cent fois moins de lignes qu'un journal brut.
