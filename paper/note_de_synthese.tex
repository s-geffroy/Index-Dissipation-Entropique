...
La section~\ref{sec:limites} énonce les limites du travail, dont la principale :
les paramètres n'ont pas de procédure de calibration empirique. L'intégralité du code, des
...
\paragraph{Absence de calibration empirique.} C'est la faiblesse principale. Les paramètres
$J$, $T$, $\gamma$, $\alpha$ n'ont aucune procédure d'estimation sur données réelles. Le
formalisme est cohérent ; son ancrage empirique reste à construire. La voie la plus
accessible serait l'estimation de $\gamma\alpha/\lambda$ par ajustement de
\eqref{eq:resonance} sur des séries temporelles de visibilité publiques.
